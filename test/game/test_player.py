...
class PlayerTest(unittest.TestCase):
    ...
    def test_final_score_one_uncompleted_destination(self):
        self.player.destinations = {4: self.destinations.get(4)}
    ...
    def test_final_score_two_uncompleted_destinations(self):
        self.player.destinations = {4: self.destinations.get(4), 5: self.destinations.get(5)}
    ...
    def test_final_score_one_completed_destination(self):
        self.player.destinations = {6: self.destinations.get(6)}
    ...
    def test_final_score_multiple_completed_destinations(self):
        self.player.destinations = {i: self.destinations.get(i) for i in [6, 17]}
