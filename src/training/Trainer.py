...
#         # Open the action space to allow us to find an optimal policy faster
...
#
#         import random
#         take_greedy_path = random.uniform(0, 1) < 0.98
#
...
#         filtered_strategy = training_strategy * action_space_np
#
#         if take_greedy_path and sum(filtered_strategy) > len(filtered_strategy):
...
#
#         # Update the strategy
#         new_strategy = Strategy.from_utility(training_strategy, utils)
